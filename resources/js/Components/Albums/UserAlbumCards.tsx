...
export default function UserAlbumCards({ albums }: { albums: Album[] | null}) {
    ...
    return albums && albums.length > 0 ? (
        albums.map((album, index) => (
            <div className=" flex h-full md:h-36 flex-col md:flex-row bg-white border rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
