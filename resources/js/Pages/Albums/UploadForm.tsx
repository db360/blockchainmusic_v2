...
export default function UploadForm() {
    ...
    const { data, setData, post, processing, errors, progress, setError } = useForm<FormInterface>({
        album_title: "",
        files: [],
        titles: [],
        image: null,
        ...
        >
            ...
            <div className="mt-2">
                <InputLabel
                    htmlFor="description"
                    value="Descripción"
                    className="mt-2" children={undefined}                />
                <TextInput
                    id="description"
                    type="text"
                    name="description"
                ...
                <TextInput
                    ...
                    onBlur={() => {
                        if (currentAlbumPrice) {
                            const formattedPrice = parseFloat(currentAlbumPrice).toFixed(2);
