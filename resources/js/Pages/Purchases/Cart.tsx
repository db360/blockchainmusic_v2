                                    ...
                                    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        ...
                                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                            ...
                                            >
                                                ...
                                                Retina 4.5K, 8GB, SSD 256GB,
                                                10-core GPU, Keyboard layout INT
                                            </a>
                                    ...
                                    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        ...
                                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                            <a
                                                ...
                                                className="text-base font-medium text-gray-900 hover:underline dark:text-white"
                                            >
                                                Restored Apple Watch Series 8
                                                (GPS) 41mm Midnight Aluminum
                                    ...
                                    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        ...
                                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                            ...
                                            >
                                                ...
                                                M3 Pro chip, 36GB Memory,
                                                18-core GPU, 512GB SSD, Space
                                                Black
                                            </a>
                                    ...
                                    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        ...
                                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                            <a
                                                ...
                                                className="text-base font-medium text-gray-900 hover:underline dark:text-white"
                                            >
                                                Tablet APPLE iPad Pro 12.9" 6th
                                                Gen, 128GB, Wi-Fi, Gold
                                            </a>
